...
Current release: **UmaLytics 0.2.1 Open Beta Hotfix**

Download the ZIP for your browser family from the [downloads](downloads) folder:

| Browser | Package |
| --- | --- |
| Chrome, Edge, Brave, Opera GX | `umalytics-chromium-0.2.1-open-beta.1.zip` |
| Firefox, LibreWolf | `umalytics-firefox-0.2.1-open-beta.1.zip` |
...
- Fixed content-script reconnect behavior after extension reloads or updates.
- Reduced cases where refreshing the scout window could clear a valid cached lobby before the page had time to re-scan.
- Rebuilt the beta ZIPs with the latest live draft history lookup fix.
