# Install or update UmaLytics 0.3.5
...
**Refresh every open drafter tab once after an upgrade, then reopen the scout.** The page hook must attach to newly created connections. Confirm v0.3.5 in the header.
